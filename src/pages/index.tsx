  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock your potential with Restaurant Booking Engine, your key to direct reservations from your website with OctoTable Online Restaurant Booking System."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock your potential with Restaurant Booking Engine, your key to direct reservations from your website with OctoTable Online Restaurant Booking System.`}
            </Text>
            <Box
